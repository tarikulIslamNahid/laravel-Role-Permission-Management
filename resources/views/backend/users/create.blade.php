    ...
    <div class="row mb-3">
        ...
        @endif
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h5 class="m-0 mt-2 font-weight-bold text-primary">Create New User</h5>
                </div>
                    ...
                    <div class="card-body">
                      <form method='POST' action="{{route('admin.users.store')}}">
                        ...
                        <div class="form-group col-lg-6">
                          ...
                          <input type="text" name='name' class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter a User Name">
