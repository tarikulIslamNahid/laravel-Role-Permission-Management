...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">User Update</h1>
      <ol class="breadcrumb">
    ...
    <div class="row mb-3">
        ...
        @endif
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h5 class="m-0 mt-2 font-weight-bold text-primary">Update User</h5>
                </div>
                    ...
                    <div class="card-body">
                      <form method='POST' action="{{route('admin.users.update',$user->id)}}">
                        ...
                        <div class="form-group col-lg-6">
                          ...
                          <input type="text" name='name' class="form-control" value="{{$user->name}}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter a User Name">

                        </div>

                        <div class="form-group col-lg-6">
                            <label for="exampleInputEmail1">User Email</label>
                            <input type="email" name='email' value="{{$user->email}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter a Email">
